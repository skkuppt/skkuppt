    ...
    return (
        <Layout pageTitle="Signup">
            ...
            <form action='/api/signup' method='POST'>
                ...
                <input minLength="5" name="emailVerification" id="emailVerification" type="emailVerification" placeholder='emailVerification again' required></input>
                <input type="submit" value="Verfity"/>
            </form>
        </Layout>
    );
}
